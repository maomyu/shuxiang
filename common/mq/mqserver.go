...
type IMMessageClient interface {
	...
	PublishOnQueue(msg []byte, consumerName string, queueName string) error
...
func (m *MessagingClient) PublishOnQueue(msg []byte, consumerName string, queueName string) error {
	if m.Conn != nil {
